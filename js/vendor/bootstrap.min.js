...
$(function(g){function s(){var b=g("script:first"),i=b.css("color"),d=false;if(/^rgba/.test(i))d=true;else try{d=i!==b.css("color","rgba(0, 0, 0, 0.5)").css("color");b.css("color",i)}catch(k){}return d}function t(b,i,d){var k=[];g.each(b,function(e){var f=[],c=b[e];e=i[e];c.b&&f.push("inset");typeof e.left!=="undefined"&&f.push(parseFloat(c.left+d*(e.left-c.left))+"px "+parseFloat(c.top+d*(e.top-c.top))+"px");typeof e.blur!=="undefined"&&f.push(parseFloat(c.blur+d*(e.blur-c.blur))+"px");typeof e.a!==
"undefined"&&f.push(parseFloat(c.a+d*(e.a-c.a))+"px");if(typeof e.color!=="undefined"){var l="rgb"+(g.support.rgba?"a":"")+"("+parseInt(c.color[0]+d*(e.color[0]-c.color[0]),10)+","+parseInt(c.color[1]+d*(e.color[1]-c.color[1]),10)+","+parseInt(c.color[2]+d*(e.color[2]-c.color[2]),10);if(g.support.rgba)l+=","+parseFloat(c.color[3]+d*(e.color[3]-c.color[3]));l+=")";f.push(l)}k.push(f.join(" "))});return k.join(", ")}function o(b){function i(){var a=/^inset\b/.exec(b.substring(h));if(a!==null&&a.length>
0){j.b=true;h+=a[0].length;return true}return false}function d(){var a=/^(-?[0-9\.]+)(?:px)?\s+(-?[0-9\.]+)(?:px)?(?:\s+(-?[0-9\.]+)(?:px)?)?(?:\s+(-?[0-9\.]+)(?:px)?)?/.exec(b.substring(h));if(a!==null&&a.length>0){j.left=parseInt(a[1],10);j.top=parseInt(a[2],10);j.blur=a[3]?parseInt(a[3],10):0;j.a=a[4]?parseInt(a[4],10):0;h+=a[0].length;return true}return false}function k(){var a=/^#([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})/.exec(b.substring(h));if(a!==null&&a.length>0){j.color=[parseInt(a[1],
16),parseInt(a[2],16),parseInt(a[3],16),1];h+=a[0].length;return true}a=/^#([0-9a-fA-F])([0-9a-fA-F])([0-9a-fA-F])/.exec(b.substring(h));if(a!==null&&a.length>0){j.color=[parseInt(a[1],16)*17,parseInt(a[2],16)*17,parseInt(a[3],16)*17,1];h+=a[0].length;return true}a=/^rgb\(\s*([0-9\.]+)\s*,\s*([0-9\.]+)\s*,\s*([0-9\.]+)\s*\)/.exec(b.substring(h));if(a!==null&&a.length>0){j.color=[parseInt(a[1],10),parseInt(a[2],10),parseInt(a[3],10),1];h+=a[0].length;return true}a=/^rgba\(\s*([0-9\.]+)\s*,\s*([0-9\.]+)\s*,\s*([0-9\.]+)\s*,\s*([0-9\.]+)\s*\)/.exec(b.substring(h));
